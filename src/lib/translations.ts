...
const translations: Record<Language, Translations> = {
  pt: {
    ...
    team: {
      ...
      bio: 'Com mais de 8 anos de experiência em estética e massoterapia, a Jessica é especialista em massagens terapêuticas e tratamentos corporais. A sua abordagem combina técnicas profissionais com atenção personalizada, garantindo bem-estar e resultados visíveis para cada cliente. Leva os tratamentos diretamente à sua casa em zonas de Lisboa e Setúbal, proporcionando uma experiência exclusiva e relaxante no seu ambiente mais confortável.',
      qualifications: [
        'Licenciatura em Estética e Cosmética',
        'Especialização em Massoterapia',
        'Certificação em Drenagem Linfática',
        'Formação em Microderme Regenerativa',
        'Membro da Associação Portuguesa de Estética',
      ],
  ...
  en: {
    ...
    team: {
      ...
      bio: 'With over 8 years of experience in aesthetics and massage therapy, Jessica is a specialist in therapeutic massages and body treatments. Her approach combines professional techniques with personalized attention, ensuring well-being and visible results for every client. She brings treatments directly to your home across Lisbon and Setúbal, providing an exclusive and relaxing experience in your most comfortable environment.',
      qualifications: [
        'Degree in Aesthetics and Cosmetics',
        'Massage Therapy Specialization',
        'Lymphatic Drainage Certification',
        'Regenerative Microderm Training',
        'Member of the Portuguese Aesthetics Association',
      ],
  ...
  es: {
    ...
    team: {
      ...
      bio: 'Con más de 8 años de experiencia en estética y masoterapia, Jessica es especialista en masajes terapéuticos y tratamientos corporales. Su enfoque combina conocimiento científico con sensibilidad y cuidado, garantizando bienestar y resultados visibles para cada clienta. Lleva los tratamientos directamente a tu hogar en zonas de Lisboa y Setúbal, proporcionando una experiencia exclusiva y personalizada.',
      qualifications: [
        'Licenciatura en Estética y Cosmética',
        'Especialización en Masoterapia',
        'Certificación en Drenaje Linfático',
        'Formación en Tratamientos Corporales',
        'Miembro de la Asociación Portuguesa de Estética',
      ],
